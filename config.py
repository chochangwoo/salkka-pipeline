...
# ── API Keys ──────────────────────────────────────
MOLIT_API_KEY    = os.getenv("MOLIT_API_KEY")       # 국토부 실거래가
KAKAO_API_KEY    = os.getenv("KAKAO_API_KEY")        # 카카오맵
...
GPT_MODEL_WRITER = "gpt-4o"         # 임장 서술, 편집장 총평 (품질 중요)
GPT_MAX_TOKENS   = 1000
...
RADIUS_MART      = 1500             # 마트 검색 반경
RADIUS_ACADEMY   = 500              # 학원 검색 반경
