...
CURATED_SUPPLY = {
    ...
    "군포시": [
        SupplyItem("산본 센트럴자이", "군포시", 1775, "2027-06", "입주예정", "시공중", "GS건설"),
        SupplyItem("군포 금정역 푸르지오", "군포시", 1210, "2028", "분양예정", "인허가", "대우건설"),
    ],
    "의왕시": [
        SupplyItem("의왕 레이크푸르지오", "의왕시", 1670, "2027-09", "입주예정", "시공중", "대우건설"),
        SupplyItem("오전동 재개발", "의왕시", 850, "2029", "정비사업", "사업시행인가", ""),
    ],
    "안양시 만안구": [
        SupplyItem("안양 관양 재개발", "안양시 만안구", 1100, "2028", "정비사업", "관리처분인가", ""),
    ],
    # ── 서울 ──
    "마포구": [
    ...
    "서대문구": [
        SupplyItem("북아현 뉴타운 3구역", "서대문구", 1620, "2027-12", "입주예정", "시공중", "대우건설"),
        SupplyItem("홍은동 재개발", "서대문구", 970, "2028", "정비사업", "관리처분인가", ""),
    ],
    "은평구": [
        SupplyItem("수색 증산 뉴타운", "은평구", 2800, "2028", "정비사업", "사업시행인가", ""),
        SupplyItem("불광동 재개발", "은평구", 1150, "2028-06", "분양예정", "착공", ""),
    ],
    "성남시 분당구": [
        SupplyItem("정자동 재건축", "성남시 분당구", 2500, "2029", "정비사업", "정비구역지정", ""),
        SupplyItem("이매동 재건축", "성남시 분당구", 1800, "2028", "정비사업", "사업시행인가", ""),
    ],
    "용인시 수지구": [
        SupplyItem("수지 성복역 롯데캐슬", "용인시 수지구", 1200, "2027-09", "입주예정", "시공중", "롯데건설"),
    ],
    "수원시 영통구": [
        SupplyItem("영통 재건축", "수원시 영통구", 2100, "2028", "정비사업", "사업시행인가", ""),
        SupplyItem("망포역 푸르지오", "수원시 영통구", 1500, "2027-06", "입주예정", "시공중", "대우건설"),
    ],
    "송파구": [
        SupplyItem("잠실 진주아파트 재건축", "송파구", 3600, "2028", "정비사업", "관리처분인가", ""),
        SupplyItem("가락시영 재건축", "송파구", 4800, "2029", "정비사업", "사업시행인가", ""),
    ],
    "노원구": [
        SupplyItem("상계주공 재건축", "노원구", 3200, "2028", "정비사업", "사업시행인가", ""),
        SupplyItem("월계 두산위브", "노원구", 1100, "2027-12", "입주예정", "시공중", "두산건설"),
    ],
}
